...
/**
 * JavaCV 取流器 SurfaceView
 * <p>
 * Created by dean on 2018/2/5.
 */
public class JavaCVReadVideoStreamingSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public JavaCVReadVideoStreamingSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                    grabber.flush();
    ...
    private void setVideoDisplay(Activity activity, Frame frame) {
        ...
        activity.runOnUiThread(() -> JavaCVReadVideoStreamingSurfaceView.this.setBackground(new BitmapDrawable(bitmap)));
    }
